...
namespace FabricTrackerMobileApp.CustomControls
{
    public partial class Accordion : ContentView
    {
        ...
        public static readonly BindableProperty HeaderTextColorProperty = BindableProperty.Create(nameof(HeaderTextColor), typeof(Color), typeof(Accordion), Color.Transparent);
